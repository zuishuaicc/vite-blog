import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.249ccecd.js";const p="/vite-blog/assets/module-federation.6c68883b.webp",F=JSON.parse('{"title":"原生webcomponent","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"views/frontend/webcomponent.md","filePath":"views/frontend/webcomponent.md","lastUpdated":null}'),e={name:"views/frontend/webcomponent.md"},o=l(`<h1 id="原生webcomponent" tabindex="-1">原生webcomponent <a class="header-anchor" href="#原生webcomponent" aria-label="Permalink to &quot;原生webcomponent&quot;">​</a></h1><h2 id="什么是webcomponent" tabindex="-1">什么是webcomponent <a class="header-anchor" href="#什么是webcomponent" aria-label="Permalink to &quot;什么是webcomponent&quot;">​</a></h2><p>Web Components 是一组不同的技术，允许你创建可重用的自定义元素 — 这些元素的功能在你的代码中可以封装起来，以便在你的 Web 应用中使用。</p><p>Web Components 标准主要由 三个 技术组成： 1.Custom Elements：一组 JavaScript API，允许你定义 custom elements 及其行为，然后在你的用户界面中使用它们。 2.Shadow DOM：一组 JavaScript API，用于封装在一个 Web 组件中的样式和标记，不受外部世界的影响，也不影响外部世界。 3.HTML Templates：<code>&lt;template&gt;</code> 和 <code>&lt;slot&gt;</code> 元素使你能够编写不在渲染页面时直接显示的标记模板。然后，你可以将这些模板当作 custom element 结构的基础复用在多个地方。</p><h2 id="创建简单的webcomponent" tabindex="-1">创建简单的webcomponent <a class="header-anchor" href="#创建简单的webcomponent" aria-label="Permalink to &quot;创建简单的webcomponent&quot;">​</a></h2><div class="language-html vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki material-theme-palenight vp-code-dark"><code><span class="line"><span style="color:#89DDFF;">&lt;</span><span style="color:#F07178;">body</span><span style="color:#89DDFF;">&gt;</span></span>
