import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.808cf4e8.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"styleCollection.md","filePath":"styleCollection.md"}'),p={name:"styleCollection.md"},o=l(`<div class="language-css vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">// 去除elementUI中table所有边框</span></span>
