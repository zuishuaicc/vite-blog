import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.808cf4e8.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"viteConfig.md","filePath":"viteConfig.md"}'),p={name:"viteConfig.md"},o=l(`<h2 id="vite-config-js中配置" tabindex="-1">vite.config.js中配置 <a class="header-anchor" href="#vite-config-js中配置" aria-label="Permalink to &quot;vite.config.js中配置&quot;">​</a></h2><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> vue </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&#39;@vitejs/plugin-vue&#39;</span></span>
