import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.b85f4cea.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"views/techStack/bat.md","filePath":"views/techStack/bat.md","lastUpdated":1715263770000}'),p={name:"views/techStack/bat.md"},e=l(`<div class="language-bat vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bat</span><pre class="shiki material-theme-palenight vp-code-dark"><code><span class="line"><span style="color:#676E95;font-style:italic;">::           --是批处理文件中一种注释语句的方式;</span></span>
