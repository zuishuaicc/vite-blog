import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.249ccecd.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"views/techStack/linux.md","filePath":"views/techStack/linux.md","lastUpdated":1715259434000}'),p={name:"views/techStack/linux.md"},e=l(`<h2 id="防火墙指令" tabindex="-1">防火墙指令 <a class="header-anchor" href="#防火墙指令" aria-label="Permalink to &quot;防火墙指令&quot;">​</a></h2><div class="language-bash vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-palenight vp-code-dark"><code><span class="line"><span style="color:#FFCB6B;">firewall-cmd</span><span style="color:#BABED8;"> </span><span style="color:#C3E88D;">--add-port=1935/tcp</span><span style="color:#BABED8;"> </span><span style="color:#C3E88D;">--permanent</span><span style="color:#BABED8;"> </span><span style="color:#676E95;font-style:italic;">#开放端口</span></span>
